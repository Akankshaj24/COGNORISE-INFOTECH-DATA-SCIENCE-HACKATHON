...
# listing all the final features
df_object = df[object_cols_to_be_kept + ['Group_no']]
...
for i in object_cols_to_be_kept:
    print(df[i].value_counts())


df_encoded = pd.get_dummies(df, columns=object_cols_to_be_kept, drop_first=True)
